...
# Класс UI окна выборочной печати на открытие (Администрация)
class GuiAdmOpenEx(QDialog):
    ...
    def init_ui(self):
        ...
        docs_data = [
            ("zayava", "Заявление", "1"),
            ("act", "Акт приёма-передачи", "1"),
            ("garant", "Гарантийное письмо", "1")
        ]
    ...
    def on_print_clicked(self):
        ...
        process_adm_open(self.order_data, selected_docs=selected_docs)
        cleanup_temp_files()
