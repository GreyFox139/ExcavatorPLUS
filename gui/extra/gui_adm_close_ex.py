...
from services.adm_close_service import process_adm_close
...
# Класс UI окна выборочной печати на закрытие (Администрация)
class GuiAdmCloseEx(QDialog):
    ...
    # Метод подключения серсиса печати (с сообщением после печати)
    def on_print_clicked(self):
        ...
        process_adm_close(self.order_data, selected_docs=selected_docs)
        cleanup_temp_files()
