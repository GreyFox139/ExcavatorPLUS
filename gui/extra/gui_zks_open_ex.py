...
# Класс UI окна выборочной печати на открытие (Жилкомсервис)
class GuiZksOpenEx(QDialog):
    ...
    def on_print_clicked(self):
        ...
        process_zks_open(self.order_data, selected_docs=selected_docs)
        cleanup_temp_files()
